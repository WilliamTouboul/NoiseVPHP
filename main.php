...
<body>
    <div class="player">
        ...
        <div class="commands">
            ...
            <svg class="play" id="play" width="28" height="33" viewBox="0 0 28 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path id="svgPlay" d="M27.1353 15.8408C27.6216 16.1307 27.6216 16.8693 27.1353 17.1592L1.57005 32.4002C1.11593 32.671 0.5 32.3492 0.5 31.7411V1.25894C0.5 0.650765 1.11593 0.329031 1.57005 0.599762L27.1353 15.8408Z" />
                <path id="svgRect" style="visibility:hidden" d="M0,0H28V28H0Z" rx="4" fill="#C4C4C4" />
                <path id="svgPlayB" d="M27.1353 15.8408C27.6216 16.1307 27.6216 16.8693 27.1353 17.1592L1.57005 32.4002C1.11593 32.671 0.5 32.3492 0.5 31.7411V1.25894C0.5 0.650765 1.11593 0.329031 1.57005 0.599762L27.1353 15.8408Z" />
            </svg>
        ...
        <input style="background-size: 100% 100%" type="range" min="0" max="100" step="1" value="100" id="soundControl">
    </div>
    ...
    <div class="toggleMobile">
        <svg width="40" style="transform:rotate(180deg)" id="arrowMenuMob" height="40" viewBox="0 0 716 721" xmlns="http://www.w3.org/2000/svg">
            <path id="path1" d="M708 313.3H627C622.4 313.3 618 315.3 614.9 318.8L396 571.1V8C396 3.6 392.4 0 388 0H328C323.6 0 320 3.6 320 8V571.1L101.1 318.8C98.1 315.3 93.7 313.3 89 313.3H7.99999C1.19999 313.3 -2.50001 321.4 1.99999 326.5L333.9 709C336.9 712.461 340.609 715.237 344.776 717.139C348.943 719.042 353.47 720.026 358.05 720.026C362.63 720.026 367.157 719.042 371.324 717.139C375.491 715.237 379.2 712.461 382.2 709L714 326.5C718.5 321.3 714.8 313.3 708 313.3Z" />
        </svg>
    ...
    <script src="assets/script/kute.js-master/dist/kute.js"></script>

    <script>
        const toggle = document.querySelector('.toggleMobile');
        const player = document.querySelector('.player');
        const azrti = document.querySelector('#arrowMenuMob');
        ...
        function toggleMenu() {
            if (screen.width < 800) {
                if (!menuDisplayed) {
                    ...
                    azrti.style.transform = "rotate(0deg)";
                    menuDisplayed = true;
                    return menuDisplayed;
                } else if (menuDisplayed) {
                    player.style.display = 'flex';
                    main.style.display = 'none';
                    azrti.style.transform = "rotate(180deg)";
                    menuDisplayed = false;
                    return menuDisplayed;
                }
            }
